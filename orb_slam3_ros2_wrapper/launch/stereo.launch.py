...
def generate_launch_description():
    ...
    def all_nodes_launch(context, robot_namespace, robot_x, robot_y):
        ...
        config_file_path = "/root/colcon_ws/src/orb_slam3_ros2_wrapper/params/gazebo_stereo.yaml"
        declare_params_file_cmd = DeclareLaunchArgument(
            'params_file',
            default_value=os.path.join(orb_wrapper_pkg, 'params', 'stereo-params.yaml'),
