...
// include logger files for ROS2
// #include "rclcpp/logger.hpp"
// #include "rclcpp/logger_severity.hpp"
...
{
    class ORBSLAM3Interface : public rclcpp::Node
    {
    public:
        ...
        bool trackStereo(const sensor_msgs::msg::Image::SharedPtr msgLeft, const sensor_msgs::msg::Image::SharedPtr msgRight, Sophus::SE3f &Tcw);
